...
import static gkemon.binarygeek.com.simplemusicplayer.Utils.getMusicList;


//Service must be initialize in menifest
public class MainActivity extends AppCompatActivity {
    ...
    ServiceConnection connection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            if(mediaPlaybackService==null)Toast.makeText(MainActivity.this,"mediaPlaybackService is null",Toast.LENGTH_LONG).show();
            else Toast.makeText(MainActivity.this,"mediaPlaybackService is not null",Toast.LENGTH_LONG).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        elapsedTimeSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                ...
                Log.d("GK","Current duration "+mediaPlaybackService.getCurrentDurationTime());
            }
        });
